...
@section('title', 'Transport Admin Login')
@section('content')
<style>
    span.app-brand-text.demo.text-body.fw-bold {
            ...
            <div class="card-body">
                ...
                <div class="app-brand justify-content-center">
                    <a href="" class="app-brand-link gap-2">
                        ...
                        <span class="app-brand-text demo text-body fw-bolder">Vat Associates</span>
                    </a>
                </div>
                <!-- /Logo -->
                <h4 class="mb-2">Welcome to Tranport Admin! 👋</h4>
